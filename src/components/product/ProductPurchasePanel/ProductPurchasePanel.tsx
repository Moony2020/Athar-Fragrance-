...
export function ProductPurchasePanel({ productSlug, productName, initialWishlisted, selectedVariant }: Props) {
  ...
  return <section aria-label="Purchase options" className={styles.panel}>
    ...
    <div className={styles.purchaseRow}>
      ...
      <WishlistButton className={styles.wishlist} initialWishlisted={initialWishlisted} productName={productName} productSlug={productSlug} />
    </div>
